...
#---------------------------------filter the both results datasets to pick the top 20 pumps for upgrade------

#subset both results_backup / results_servo to find the pumps that need to be upgraded efficiently 

results_backup_sub<-results_backup[results_backup$new_time<48,]

View(results_backup_sub)


results_servo_sub<-results_servo[results_servo$new_time<48,]
View(results_servo_sub)

#******from these two sub datasets. pick out 20 pumps that have the lowest 'old time', and highest 'pred_time_diff' 
#***************************************************************************************************************
